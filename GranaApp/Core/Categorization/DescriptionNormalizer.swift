...
/// Normaliza descrições de transações para agrupar lançamentos recorrentes
...
///   Mantém runs curtos (data `dia 5`, parcela `1/3`, `12/24`).
///
...
nonisolated enum DescriptionNormalizer {
    ...
    /// SHA256 hex da descrição normalizada.
